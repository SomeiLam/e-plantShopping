            ...
            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
              <h1 className="cart">
                ...
                <span
                  style={{
                    position: 'absolute',
                    top: '8px', // Adjust based on the icon size
                    right: '8px', // Adjust based on the icon size
                    backgroundColor: 'red', // Background color for the number circle
                    color: 'white',
                    borderRadius: '50%',
                    padding: '5px 10px',
                    fontSize: '14px',
                  ...
                  {category.plants.map((plant) => {
                    ...
                    return (
                      <div className="product-card" key={plant.name}>
                        <h6 className="product-title">{plant.name}</h6>
                        <img
                          src={plant.image}
                          alt={plant.name}
